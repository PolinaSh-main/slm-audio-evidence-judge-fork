...
| 1 | Introduction (1 p) [MIN] | M3 → M1 | problem; pilot finding "epistemic reasoning, not hearing"; gap; 3 contribution bullets |
| 2 | Related Work (1–1.5 p) [MIN] | M3 → M1 | 4 paragraphs: audio-QA hallucination benchmarks (01, 03) · mitigation for audio LLMs (02, 26, 27) · text-LLM probing & uncertainty (24 + classics) · positioning vs 25: *output-level* uncertainty there, *pre-generation* here |
